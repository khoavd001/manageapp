...
public class BaiHat implements Parcelable {
    ...
    public static final Creator<BaiHat> CREATOR = new Creator<BaiHat>() {
        @Override
        public com.example.manage.Model.BaiHat createFromParcel(Parcel in) {
            return new com.example.manage.Model.BaiHat(in);
        }

        @Override
        public com.example.manage.Model.BaiHat[] newArray(int size) {
            return new com.example.manage.Model.BaiHat[size];
        }
    };
